...
namespace llvm
{
    ...
    class SmallVectorBase
    {
      protected:
        ...
        SmallVectorBase(void* FirstEl, size_t Capacity) : BeginX(FirstEl), Capacity(Capacity) {}
    ...
    class SmallVectorTemplateCommon : public SmallVectorBase
    {
      ...
      protected:
        ...
        void grow_pod(size_t MinCapacity, size_t TSize) { SmallVectorBase::grow_pod(getFirstEl(), MinCapacity, TSize); }
    ...
    {
        if (MinSize > UINT32_MAX) report_bad_alloc_error("SmallVector capacity overflow during allocation");
    ...
    class SmallVectorImpl : public SmallVectorTemplateBase<T>
    {
      ...
      protected:
        ...
        explicit SmallVectorImpl(unsigned N) : SmallVectorTemplateBase<T, isPodLike<T>::value>(N) {}
