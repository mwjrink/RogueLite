...
#undef R6
    ...
    T reverseBits(T Val)
    {
        ...
        for (unsigned i = 0; i < sizeof(Val); ++i) out[(sizeof(Val) - i) - 1] = BitReverseTable256[in[i]];
    ...
    constexpr inline bool isPowerOf2_64(uint64_t Value) { return Value && !(Value & (Value - 1)); }
