...
namespace proc_anim
{
    void set_unit_velocity_up(HumanoidSkeleton* s) { s->heart.velocity.y++; }
    void set_unit_velocity_down(HumanoidSkeleton* s) { s->heart.velocity.y--; }
    void set_unit_velocity_left(HumanoidSkeleton* s) { s->heart.velocity.x--; }
    void set_unit_velocity_right(HumanoidSkeleton* s) { s->heart.velocity.x++; }
    void stop_velocity_up(HumanoidSkeleton* s) { s->heart.velocity.y--; }
    void stop_velocity_down(HumanoidSkeleton* s) { s->heart.velocity.y++; }
    void stop_velocity_left(HumanoidSkeleton* s) { s->heart.velocity.x++; }
    void stop_velocity_right(HumanoidSkeleton* s) { s->heart.velocity.x--; }

    void reset(HumanoidSkeleton* s)
    {
    ...
    HumanoidSkeleton::HumanoidSkeleton(/*LOAD THESE IN *****/)
    {
