...
// An abstract camera class that processes input and calculates the corresponding Euler Angles, Vectors and Matrices for use
// in OpenGL
class Camera
{
  public:
    ...
    Camera(glm::vec3 position = glm::vec3(-10.0f, 0.0f, 0.0f), glm::vec3 up = glm::vec3(0.0f, 0.0f, 1.0f), float yaw = YAW,
           float pitch = PITCH)
