...
namespace proc_anim
{
    ...
    void set_unit_velocity_up(HumanoidSkeleton* s);
    void set_unit_velocity_down(HumanoidSkeleton* s);
    void set_unit_velocity_left(HumanoidSkeleton* s);
    void set_unit_velocity_right(HumanoidSkeleton* s);
    void stop_velocity_up(HumanoidSkeleton* s);
    void stop_velocity_down(HumanoidSkeleton* s);
    void stop_velocity_left(HumanoidSkeleton* s);
    void stop_velocity_right(HumanoidSkeleton* s);
